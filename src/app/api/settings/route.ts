  ...
  try {
    ...
    const settings = await prisma.siteSetting.upsert({
      ...
      create: {
        ...
        whatsappNumber: whatsappNumber?.trim() || '919876543210',
        ...
        openingHours: openingHours?.trim() || 'Mon - Sat: 10:30 AM - 8:00 PM',
        aboutStory: aboutStory?.trim(),
        ...
        glamPhone: glamPhone?.trim() || '+91 98765 43210',
        glamWhatsappNumber: glamWhatsappNumber?.trim() || '919876543210',
